...
export default function AuthLayout({ children }: React.PropsWithChildren) {
  return (
    <div className="h-screen w-full flex items-center justify-center relative bg-dark1">
      {/* <div className="absolute inset-20 hidden lg:block">
        <Image
      ...
      <div className="bg-gradient-to-br from-primary via-transparent to-primary absolute inset-0 hidden lg:block"></div>
